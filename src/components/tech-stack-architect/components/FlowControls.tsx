    ...
    <div className="absolute top-4 right-4 z-10 flex gap-4">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-md flex items-center gap-2 transition-colors"
          title="Save Stack"
        >
          <Save size={20} />
          <span>Save</span>
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="p-2 rounded-md bg-orange-600 hover:bg-orange-700 text-white transition-colors"
          title="Export Image"
        >
