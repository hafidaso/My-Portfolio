      ...
      <div className="p-3 border-b border-gray-200 dark:border-gray-700 space-y-2 flex-shrink-0">
        <div className="relative">
          <input
            ...
            className="w-full bg-white dark:bg-gray-700 text-gray-900 dark:text-white pl-9 pr-3 py-1.5 rounded focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all text-sm border border-gray-200 dark:border-gray-600"
          />
        ...
        <select
          ...
          className="w-full bg-white dark:bg-gray-700 text-gray-900 dark:text-white px-2 py-1.5 rounded focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all text-sm border border-gray-200 dark:border-gray-600"
        >
          ...
          filteredTechnologies.map((tech) => (
            ...
            >
              <div className="flex items-center">
                ...
                <span className="group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors text-sm">{tech.name}</span>
              </div>
            </div>
          ))
        ) : (
          ...
          {savedStacks.map((stack) => (
            ...
            >
              <button
                ...
                className="text-sm text-gray-900 dark:text-white hover:text-orange-500 dark:hover:text-orange-400 transition-colors"
              >
                {stack.name}
              </button>
              <button
