        ...
        <div className="h-full overflow-y-auto px-6 py-8 scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent">
          ...
          <div className="relative flex items-center space-x-4 mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-orange-400 font-medium">{tech.category}</p>
            </div>
          </div>

          {/* Version Badge */}
          {tech.version && (
            <div className="inline-block px-3 py-1 rounded-full bg-orange-500/10 text-orange-400 text-sm font-medium mb-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              >
                <Github className="w-5 h-5 text-gray-400 group-hover:text-orange-400" />
                <span className="text-gray-300 group-hover:text-orange-400 text-sm">GitHub Projects</span>
              ...
              <a
                ...
                className="flex items-center space-x-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors group"
              >
                <Package className="w-5 h-5 text-gray-400 group-hover:text-orange-400" />
                <span className="text-gray-300 group-hover:text-orange-400 text-sm">NPM Packages</span>
                <ExternalLink className="w-4 h-4 text-gray-500 ml-auto" />
              </a>
            </div>
          </div>
