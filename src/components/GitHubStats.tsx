...
const GitHubStats: React.FC = () => {
  ...
  const stats = [
    { label: 'Repositories', value: userData?.public_repos || 0, icon: <Book className="w-5 h-5 text-orange-400" /> },
  ...
  return (
    <div className="bg-[#F8FAFC] dark:bg-[#151B28] rounded-lg p-3 h-full transition-colors">
      <h2 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-orange-600 mb-3">
        GitHub Stats
      </h2>
        ...
        <div className="h-[210px]">
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              ...
              <Tooltip
                  contentStyle={{
                    backgroundColor: 'rgba(255, 255, 255, 0.95)', // fond clair semi-transparent
                    border: '1px solid #e5e7eb', // fine bordure gris clair
                    borderRadius: '8px',
                    color: '#111827', // texte très foncé (gris anthracite)
                    fontSize: '0.875rem', // taille du texte légèrement réduite
                    boxShadow: '0 2px 8px rgba(0, 0, 0, 0.1)' // une légère ombre pour la lisibilité
                  }}
                  itemStyle={{
                    color: '#111827' // couleur des items dans le tooltip
                  }}
                  cursor={{ fill: 'rgba(0, 0, 0, 0.05)' }} // effet de survol discret
              />
            </PieChart>
          </ResponsiveContainer>
        </div>
