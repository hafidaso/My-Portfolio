...
if (!hasSupabaseConfig) {
  console.log("⚠️  Supabase configuration not found. Skipping embeddings generation.");
  console.log("   To enable embeddings, set SUPABASE_URL and SUPABASE_ANON_KEY in .env.local");
  process.exit(0);
}
